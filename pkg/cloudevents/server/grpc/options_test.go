...
func TestNewBrokerOptions(t *testing.T) {
	...
	if !opts.HeartbeatEnabled {
		t.Errorf("Expected HeartbeatEnabled to be true by default, got false")
	}
...
func TestBrokerOptions_AddFlags(t *testing.T) {
	...
	if fs.Lookup("broker-heartbeat-enabled") == nil {
		t.Error("broker-heartbeat-enabled flag not registered")
	}
	...
	// Test parsing flags
	args := []string{
		"--broker-heartbeat-enabled=false",
	...
	if opts.HeartbeatEnabled {
		t.Errorf("Expected HeartbeatEnabled to be false after parsing, got true")
	}
...
func TestNewGRPCBroker_WithOptions(t *testing.T) {
	...
	if broker.heartbeatEnabled {
		t.Errorf("Expected HeartbeatEnabled to be false, got true")
	}
