...
func NewAgentClientHolder(ctx context.Context, opt *options.GenericClientOptions[*clusterv1.ManagedCluster]) (*ClientHolder, error) {
	...
	managedClusterClient := agent.NewManagedClusterClient(cloudEventsClient, opt.WatcherStore(), opt.ClusterName())
