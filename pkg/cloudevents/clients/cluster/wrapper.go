...
import (
	...
	"open-cluster-management.io/sdk-go/pkg/cloudevents/clients/cluster/agent"
)

// ClusterClientSetWrapper wraps a cluster client that has a ManagedCluster client to a cluster clientset interface, this wrapper
// will helps us to build ManagedCluster informer factory easily.
...
func (c *ClusterV1ClientWrapper) ManagedClusters() clusterv1client.ManagedClusterInterface {
	if agentManagedClusterClient, ok := c.ManagedClusterClient.(*agent.ManagedClusterClient); ok {
